aaaa<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!DOCTYPE html>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_text text-center">
                            <div class="login_part_text_iner">
                                <h2>Bạn có muốn đăng ký tài không? Hãy bấm vào Đăng ký</h2>
    ...
    <div class="search-model-box">
        <div class="h-100 d-flex align-items-center justify-content-center">
            ...
            <form class="search-model-form" action="search" method="get">
                <input type="text" id="search-input" placeholder="Tìm kiếm mọi thứs....." name="keyword" size="50" >
            </form>
        </div>
    </div>
    <!-- Search model end -->
