               ...
               <div class="row">
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-70">
                        <a href="${pageContext.request.contextPath}/" class="btn view-btn1">Sách Bán Chạy Nhất</a>
                    </div>
                </div>
                <br>
                <div class="row">
				 ...
				 <div class="row justify-content-center">
                    <div class="room-btn pt-70">
                        <a href="${pageContext.request.contextPath}/" class="btn view-btn1">Sách được yêu thích nhất</a>
                    </div>
                </div>
                <br>
                <div class="row">
