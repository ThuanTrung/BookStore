...
<head>
    ...
    <title>Xem thanh toán - Books Store</title>
        ...
        <section class="checkout_area">
            ...
            <div class="returning_customer">
              <div class="check_title">
                <h2 class="text-center">
                  Để hoàn tất giao dịch của bạn, chúng tôi sẽ chuyển bạn đến các máy chủ an toàn của PayPal.
                </h2>
              </div>
          ...
          <br>
            <div class="billing_details ">
              <div class="row">
              <h2>Thông tin người trả tiền</h2>
            ...
            <input type="hidden" name="PayerID" value="${param.PayerID}"/>
			 	<button class="btn primary" type="submit">Thanh toán ngay</button>
			 </form>
          </div>
        </section>
        <!--================End Checkout Area =================-->
