        ...
        <section class="checkout_area">
          <div class="container">
            <div class="returning_customer">
             <h1 class="text-center">Thủ tục thanh toán</h1> <br> <br>
              <div class="check_title">           
                ...
                <c:if test="${cart.totalItems == 0}">
					<h2 class="text-center" style="color: red;">Không có mặt hàng nào trong giỏ hàng của bạn</h2>
		        </c:if>    
              </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="order_box">
                    ...
                    <br><br>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn primary checkout_btn_1" type="submit">Hoàn thành thanh toán</button>
                  </div>
                </div>
              </div>
              </form>
