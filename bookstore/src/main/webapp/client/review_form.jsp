                            ...
                            <div class="login_part_form_iner">
                                ...
                                <form class="row contact_form" id="reviewForm" action="submit_review" method="post">
                                    <div class="col-md-12 form-group p_star">
                                     ...
                                     <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" name="headline" size="60" placeholder="Tiêu đề" />
                                    </div>
                                     <div class="col-md-12 form-group p_star">
                                        <textarea name="comment" cols="50" rows="5" placeholder="Viết chi tiết đánh giá của bạn..." ></textarea>
                                    </div>
