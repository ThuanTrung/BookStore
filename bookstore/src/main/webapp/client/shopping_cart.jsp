...
<head>
 ...
 <link rel="shortcut icon" type="image/x-icon" href="assets/img/logo/em.jpg">
    <!-- CSS here -->
	...
	<jsp:directive.include file="header.jsp" />
       ...
       <main>
			...
			<c:if test="${cart.totalItems == 0}">
				<h2 class="text-center">Không có mặt hàng nào trong giỏ hàng của bạn</h2>
			</c:if>
          ...
          <div class="cart_inner">
            <div class="table-responsive">        
              <table class="table">
                ...
                <c:forEach items="${cart.items}" var="item" varStatus="status" >
                  ...
                  <td>${status.index + 1}</td>
                    ...
                    <td><a style="color: red;" href="remove_from_cart?book_id=${item.key.bookId}">Xoá</a></td>
                  </tr>
                  ...
                  <tr class="bottom_button">
                    ...
                    <td>
                      ...
                      <input class="btn primary" type="button" id="clearCart" value="Xoá Khỏi Giỏ Hàng"/>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td></td>
                    <td></td>
                    <td><h5>Items: ${cart.totalQuantity} sách(s)</h5></td> <br>
                    <td>
                      <h5>Tổng cộng: $ ${cart.totalAmount}</h5>
                    </td>
              ...
              <div class="checkout_btn_inner float-right">
                ...
                <a class="btn primary checkout_btn_1" href="checkout">Đặt Hàng</a>
              </div>
            </div>
          </div>
          </form>
