package com.ht22.service;

import static com.ht22.common.Utitlity.forwardToPage;
import static com.ht22.common.Utitlity.showMessageBackend;
import static com.ht22.common.Utitlity.showMessageFrontend;
...
import com.ht22.dao.BookDAO;
import com.ht22.dao.CategoryDAO;
import com.ht22.dao.OrderDAO;
import com.ht22.entity.Book;
import com.ht22.entity.Category;
...
public class BookService {
    ...
    public void deleteBook(int bookId) throws ServletException, IOException {
        // Kiểm tra xem quyển sách có tồn tại hay không
        Book existBook = bookDAO.get(bookId);

        if (existBook == null) {
            // Trả về lỗi hoặc thông báo rằng không tìm thấy quyển sách
            throw new ServletException("Could not find book with ID " + bookId);
        }
	...
	public List<Book> listBooks() throws ServletException, IOException {
		listBooks(null);
		return null;
	}
	...
	public void search() throws ServletException, IOException {
		...
		forwardToPage("client/search_result.jsp", request, response);
	}
